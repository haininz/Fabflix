...
function handleSelectSuggestion(suggestion) {
    ...
    let changeHref = "single-movie.html?id=" + suggestion["data"]["movies_id"];
    window.location.replace(changeHref);

    console.log("you select " + suggestion["value"] + " with ID " + suggestion["data"]["movies_id"])
}
...
function handleNormalSearch(query) {
    ...
    let temp_href = "searchResult.html?movie_title=" + query + "&movie_year=&movie_director=&star_name=&jump=&number_page=&sort_base=";
    window.location.replace(temp_href);
