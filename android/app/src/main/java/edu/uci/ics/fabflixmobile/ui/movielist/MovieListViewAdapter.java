...
public class MovieListViewAdapter extends ArrayAdapter<Movie> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.yearDir = convertView.findViewById(R.id.year_director);
//            viewHolder.director = convertView.findViewById(R.id.director);
        ...
        viewHolder.yearDir.setText(movie.getYear() + " " + movie.getDirector() + " ");
//        viewHolder.director.setText(movie.getDirector());
        viewHolder.genres.setText(movie.getThree_genres());
        viewHolder.stars.setText(movie.getThree_stars());
